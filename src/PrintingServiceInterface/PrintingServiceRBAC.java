...
public class PrintingServiceRBAC extends UnicastRemoteObject implements PrintingInterface {
    ...
    public PrintingServiceRBAC() throws RemoteException {
        super();
